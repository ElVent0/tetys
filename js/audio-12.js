var Framer = {
  ...
  drawTick: function (x1, y1, x2, y2) {
    ...
    gradient.addColorStop(0.6, "#f7f9ff");
    gradient.addColorStop(1, "#537dee");
    this.context.beginPath();
...
var Scene = {
  ...
  canvasConfigure: function () {
    ...
    this.context.strokeStyle = "#f7f9ff";
    this.calculateSize();
  },

  calculateSize: function () {
    this.scaleCoef = Math.max(0.2, 40 / this.optimiseHeight);
...
var Controls = {
  ...
  drawPic: function () {
    this.context.save();
    this.context.beginPath();
    this.context.fillStyle = "rgba(83, 125, 238, 1)";
    this.context.lineWidth = 1;
...
var Player = {
  ...
  tracks: [
    {
      artist: "What are you fighting for",
      song: "3 min",
      url: "../audio/WhatAreYouFightingFor.mp3",
    },
  ],
